...
class SimpleParticleSystem extends THREE.Object3D {
  constructor(options) {
    ...
    this.particleShaderGeo.setAttribute(
      'position',
      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setUsage(THREE.DynamicDrawUsage)
    )
    this.particleShaderGeo.setAttribute(
      'destination',
      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT * 3), 3).setUsage(THREE.DynamicDrawUsage)
    ...
    this.particleShaderGeo.setAttribute(
      'size',
      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setUsage(THREE.DynamicDrawUsage)
    )
    this.particleShaderGeo.setAttribute(
      'lifeOffset',
      new THREE.BufferAttribute(new Float32Array(this.PARTICLE_COUNT), 1).setUsage(THREE.DynamicDrawUsage)
